/*
  ...
  - A document as a hierarchy of nodes
    > The DOM represents an HTML document as a hierarchy of nodes. Consider the following HTML document: pic1
    > The following tree represents the above HTML document: pic2
  ...
  - Node and Element
    ...
    + The following picture illustrates the relationship between the Node and Element types: pic3
  ...
  - Node Relationships
    ...
    + The following picture illustrates the relationships between nodes: pic4
